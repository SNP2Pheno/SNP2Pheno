...
def getSignificant(current_associations, threshold=5e-8, or_min=1.2, or_max=0.8, beta_threshold=0.2):
    res = []
#    current_traits = ["blood group A", "blood group B", "blood group AB", "blood group 0" ]
...
for rs in open('snp_ids_listBloodTypesGene.txt').read().splitlines():
